...
export default function SourcesSidebar({ sources, fetchFiles, open }) {
    ...
    return (
        <aside className="w-100  h-full  overflow-y-auto  border border-gray-700 bg-[#181818] rounded-2xl p-4 flex flex-col shadow-lg">
